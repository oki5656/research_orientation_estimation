...
if __name__ == '__main__':
    ...
    parser.add_argument('--csv_path', type=str, default="C:/Users/admin/Desktop/orientation_estimation/open_dataset/experiment_result/test1_1129_1619/cut_sensorlog_20221123_161907.csv", help='specify csv file path.')
    parser.add_argument('--images_dir', type=str, default="C:/Users/admin/Desktop/orientation_estimation/open_dataset/experiment_result/test1_1129_1619/cut_images", help='specify images folder path.')
    parser.add_argument('--drawed_img_dir', type=str, default="C:/Users/admin/Desktop/orientation_estimation/open_dataset/experiment_result/test1_1129_1619/drawed_img_multi_model", help='specify drawed images folder path.')
