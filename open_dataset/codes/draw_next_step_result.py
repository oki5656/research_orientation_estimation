...
if __name__ == '__main__':
    ...
    parser.add_argument('--csv_path', type=str, default="C:/Users/admin/Desktop/orientation_estimation/open_dataset/experiment_result/field_experiment/ped/nakamura2/cut_nakamura_ped2_sensorlog_20221217_133201.csv", help='specify csv file path.')
    parser.add_argument('--images_dir', type=str, default="C:/Users/admin/Desktop/orientation_estimation/open_dataset/experiment_result/field_experiment/ped/nakamura2/cut_images", help='specify images folder path.')
    parser.add_argument('--drawed_img_dir', type=str, default="C:/Users/admin/Desktop/orientation_estimation/open_dataset/experiment_result/field_experiment/ped/nakamura2/drawed_img_single_model", help='specify drawed images folder path.')
