...
new_imu_path = path.join("..", "datasets", "dataset-room2_512_16", "mav0", "imu0", "new_data_imu.csv")
...
out_all_in_df_path = path.join("..", "datasets", "dataset-room2_512_16", "mav0", "self_made_files", "all_in_imu_mocap.csv")
######################################################################################################
